...
class GooWordStat {
    ...
    public String searchCount(int freq) {
        if (freq < 1000) {
            return "LOW";
        } else if (freq >= 1000 && freq < 100_000) {
            return "MEDIUM";
        } else if (freq >= 100_000 && freq < 10_000_000) {
            return "HIGH";
        }
        return "EXTRA HIGH";
    }
    ...
    public String toString() {
        return "Word is [" + word + "], search freq is " + searchCount(freq);
    }
}
